    ...
    <footer className="bg-brand-dark text-white">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1.2fr_1fr_1fr_1fr_1.2fr]">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="mb-4 text-sm font-semibold text-white/60">{t("common.quickLinks")}</h3>
          ...
          {/* Support */}
          <div>
            <h3 className="mb-4 text-sm font-semibold text-white/60">{t("common.support")}</h3>
            <ul className="space-y-2">
          ...
          {/* Contact */}
          <div>
            <h3 className="mb-4 text-sm font-semibold text-white/60">{t("common.contactUs")}</h3>
